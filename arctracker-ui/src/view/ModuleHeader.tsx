...
export default function ModuleHeader() {
  ...
  const LoadIcon = () => (
    <>
      ...
      <span className="visually-hidden">{message("loadModuleHintText")}</span>
    </>
  );
  ...
  const SaveIcon = () => (
    <>
      ...
      <span className="visually-hidden">{message("saveModuleHintText")}</span>
    </>
  );
  ...
  const BounceIcon = () => (
    <>
      ...
      >
        ...
        <span className="visually-hidden">{message("bounceAudioHintText")}</span>
      </svg>
    </>
  );
  ...
  const EditNameIcon = () => (
    <>
      ...
      >
        ...
        <span className="visually-hidden">{message("editModuleDetailsHintText")}</span>
      </svg>
    </>
  );
