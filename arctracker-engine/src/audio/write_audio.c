...
audio_out_result_t write_audio_data(audio_out_t *audio_out, voice_t *voices, int samples_to_write)
{
    ...
    while (samples_to_write)
    {
        ...
        const audio_api_result_t fill_result = fill_audio_buffer(audio_out, voices, samples_to_write_now);
...
static audio_api_result_t fill_audio_buffer(audio_out_t *audio_out, voice_t *voices, const int frames_to_fill)
{
    ...
    const audio_api_result_t result = mix_and_send(audio_out);
    audio_out->frames_filled = 0;
    return result;
}
